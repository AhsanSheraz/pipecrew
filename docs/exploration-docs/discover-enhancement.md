...
> **Status as of 2026-05-31**: Wins #1, #2, #3, #5, and #6 are CLOSED. Win #4 (outline gate) and Win #7 (downstream artifact caching) are open. See "What shipped / what's open" at the bottom.
