...
2. Generates the workspace skeleton: `config.json`, `context/platform.md`, `context/audit-findings.md`, `context/architecture.mmd`, `context/architecture-overview.mmd`, `context/learn-log.md`.
